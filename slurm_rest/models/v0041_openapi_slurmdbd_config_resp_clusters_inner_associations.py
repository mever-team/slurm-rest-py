...
class V0041OpenapiSlurmdbdConfigRespClustersInnerAssociations(BaseModel):
    ...
    """ # noqa: E501
    root: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerAssociation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": V0041OpenapiSlurmdbdJobsRespJobsInnerAssociation.from_dict(obj["root"]) if obj.get("root") is not None else None
        })
        return _obj
