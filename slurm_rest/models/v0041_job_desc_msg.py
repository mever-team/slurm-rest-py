...
class V0041JobDescMsg(BaseModel):
    ...
    begin_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    resv_mpi_ports: Optional[StrictInt] = Field(default=None, description="Number of reserve communication ports. Can only be used if slurmstepd step manager is enabled.")
    script: Optional[StrictStr] = Field(default=None, description="Job batch script. Only first component in a HetJob is populated or honored.")
    ...
    kill_warning_delay: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    ...
    required_switches: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "begin_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["begin_time"]) if obj.get("begin_time") is not None else None,
            "flags": obj.get("flags"),
            ...
            "kill_warning_delay": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["kill_warning_delay"]) if obj.get("kill_warning_delay") is not None else None,
            ...
            "required_switches": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["required_switches"]) if obj.get("required_switches") is not None else None,
