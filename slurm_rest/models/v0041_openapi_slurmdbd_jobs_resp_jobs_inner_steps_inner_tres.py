...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTres(BaseModel):
    ...
    consumed: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequested] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consumed": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequested.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None,
