...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMax(BaseModel):
    ...
    accruing: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobs] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accruing": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxJobsActiveJobs.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None
        })
        return _obj
