...
class V0041OpenapiPartitionRespPartitionsInnerMaximums(BaseModel):
    ...
    """ # noqa: E501
    cpus_per_node: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    cpus_per_socket: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    memory_per_cpu: Optional[StrictInt] = None
    partition_memory_per_cpu: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    partition_memory_per_node: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    nodes: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    shares: Optional[StrictInt] = None
    oversubscribe: Optional[V0040PartitionInfoMaximumsOversubscribe] = None
    time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    over_time_limit: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cpus_per_node": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["cpus_per_node"]) if obj.get("cpus_per_node") is not None else None,
            "cpus_per_socket": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["cpus_per_socket"]) if obj.get("cpus_per_socket") is not None else None,
            "memory_per_cpu": obj.get("memory_per_cpu"),
            "partition_memory_per_cpu": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["partition_memory_per_cpu"]) if obj.get("partition_memory_per_cpu") is not None else None,
            "partition_memory_per_node": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["partition_memory_per_node"]) if obj.get("partition_memory_per_node") is not None else None,
            "nodes": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["nodes"]) if obj.get("nodes") is not None else None,
            ...
            "time": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["time"]) if obj.get("time") is not None else None,
            "over_time_limit": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["over_time_limit"]) if obj.get("over_time_limit") is not None else None
        })
        return _obj
