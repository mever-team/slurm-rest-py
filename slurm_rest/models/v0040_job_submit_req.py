...
class V0040JobSubmitReq(BaseModel):
    ...
    V0040JobSubmitReq
    """ # noqa: E501
    script: Optional[StrictStr] = Field(default=None, description="Batch job script. Batch script must be specified in first component of jobs or in job if this field is not populated.")
