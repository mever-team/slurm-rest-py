...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequested(BaseModel):
    ...
    """ # noqa: E501
    max: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = None
    min: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = None
    average: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = None
