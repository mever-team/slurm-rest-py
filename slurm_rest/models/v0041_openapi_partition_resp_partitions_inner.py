...
class V0041OpenapiPartitionRespPartitionsInner(BaseModel):
    ...
    select_type: Optional[List[StrictStr]] = Field(default=None, description="Scheduler consumable resource selection types")
    ...
    suspend_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suspend_time": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["suspend_time"]) if obj.get("suspend_time") is not None else None
        })
        return _obj
