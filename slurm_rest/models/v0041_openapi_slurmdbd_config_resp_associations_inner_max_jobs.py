...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobs(BaseModel):
    ...
    active: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    accruing: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    total: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "active": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["active"]) if obj.get("active") is not None else None,
            ...
            "total": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["total"]) if obj.get("total") is not None else None
        })
        return _obj
