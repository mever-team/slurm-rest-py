...
class V0041OpenapiPartitionRespPartitionsInnerTimeouts(BaseModel):
    ...
    """ # noqa: E501
    resume: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    suspend: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resume": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["resume"]) if obj.get("resume") is not None else None,
            "suspend": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["suspend"]) if obj.get("suspend") is not None else None
        })
        return _obj
