...
class Dbv0039Meta(BaseModel):
    ...
    Dbv0039Meta
    """ # noqa: E501
    plugin: Optional[V0039MetaPlugin] = None
    slurm: Optional[V0039MetaSlurm] = Field(default=None, alias="Slurm")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plugin": V0039MetaPlugin.from_dict(obj["plugin"]) if obj.get("plugin") is not None else None,
            "Slurm": V0039MetaSlurm.from_dict(obj["Slurm"]) if obj.get("Slurm") is not None else None
        })
        return _obj
