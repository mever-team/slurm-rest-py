...
class V0041OpenapiJobInfoRespJobsInnerJobResourcesNodes(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="Number of nodes assigned to job")
    select_type: Optional[List[StrictStr]] = Field(default=None, description="Node scheduling selection request")
    list: Optional[StrictStr] = Field(default=None, description="host list for job")
    whole: Optional[StrictBool] = Field(default=None, description="Job allocated full nodes")
    allocation: Optional[List[V0041OpenapiJobInfoRespJobsInnerJobResourcesNodesAllocationInner]] = Field(default=None, description="resource allocations by node")
