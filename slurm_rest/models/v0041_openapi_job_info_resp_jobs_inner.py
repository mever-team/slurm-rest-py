...
class V0041OpenapiJobInfoRespJobsInner(BaseModel):
    ...
    accrue_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    admin_comment: Optional[StrictStr] = None
    allocating_node: Optional[StrictStr] = None
    array_job_id: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    array_task_id: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    array_max_tasks: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    cores_per_socket: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    billable_tres: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor] = None
    cpus_per_task: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    cpu_frequency_minimum: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    cpu_frequency_maximum: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    cpu_frequency_governor: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    cpus_per_tres: Optional[StrictStr] = None
    cron: Optional[StrictStr] = None
    deadline: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    delay_boot: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    dependency: Optional[StrictStr] = None
    derived_exit_code: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerDerivedExitCode] = None
    eligible_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    end_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    het_job_id: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    het_job_id_set: Optional[StrictStr] = None
    het_job_offset: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    last_sched_evaluation: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    licenses: Optional[StrictStr] = None
    mail_type: Optional[List[StrictStr]] = None
    mail_user: Optional[StrictStr] = None
    max_cpus: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    max_nodes: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    tasks_per_core: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    tasks_per_tres: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    tasks_per_node: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    tasks_per_socket: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    tasks_per_board: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    cpus: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    node_count: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    tasks: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    minimum_cpus_per_node: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    minimum_tmp_disk_per_node: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    power: Optional[V0041OpenapiJobInfoRespJobsInnerPower] = None
    preempt_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    preemptable_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    pre_sus_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    resize_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    sockets_per_node: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    start_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    submit_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    suspend_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    system_comment: Optional[StrictStr] = None
    time_limit: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    time_minimum: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    threads_per_core: Optional[V0041JobDescMsgDistributionPlaneSize] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accrue_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["accrue_time"]) if obj.get("accrue_time") is not None else None,
            "admin_comment": obj.get("admin_comment"),
            "allocating_node": obj.get("allocating_node"),
            "array_job_id": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["array_job_id"]) if obj.get("array_job_id") is not None else None,
            ...
            "array_max_tasks": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["array_max_tasks"]) if obj.get("array_max_tasks") is not None else None,
            ...
            "cores_per_socket": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["cores_per_socket"]) if obj.get("cores_per_socket") is not None else None,
            "billable_tres": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor.from_dict(obj["billable_tres"]) if obj.get("billable_tres") is not None else None,
            "cpus_per_task": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["cpus_per_task"]) if obj.get("cpus_per_task") is not None else None,
            "cpu_frequency_minimum": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["cpu_frequency_minimum"]) if obj.get("cpu_frequency_minimum") is not None else None,
            "cpu_frequency_maximum": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["cpu_frequency_maximum"]) if obj.get("cpu_frequency_maximum") is not None else None,
            "cpu_frequency_governor": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["cpu_frequency_governor"]) if obj.get("cpu_frequency_governor") is not None else None,
            "cpus_per_tres": obj.get("cpus_per_tres"),
            "cron": obj.get("cron"),
            "deadline": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["deadline"]) if obj.get("deadline") is not None else None,
            "delay_boot": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["delay_boot"]) if obj.get("delay_boot") is not None else None,
            ...
            "eligible_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["eligible_time"]) if obj.get("eligible_time") is not None else None,
            "end_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["end_time"]) if obj.get("end_time") is not None else None,
            ...
            "het_job_id": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["het_job_id"]) if obj.get("het_job_id") is not None else None,
            "het_job_id_set": obj.get("het_job_id_set"),
            "het_job_offset": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["het_job_offset"]) if obj.get("het_job_offset") is not None else None,
            ...
            "last_sched_evaluation": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["last_sched_evaluation"]) if obj.get("last_sched_evaluation") is not None else None,
            "licenses": obj.get("licenses"),
            "mail_type": obj.get("mail_type"),
            "mail_user": obj.get("mail_user"),
            "max_cpus": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["max_cpus"]) if obj.get("max_cpus") is not None else None,
            "max_nodes": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["max_nodes"]) if obj.get("max_nodes") is not None else None,
            ...
            "nodes": obj.get("nodes"),
            "nice": obj.get("nice"),
            "tasks_per_core": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["tasks_per_core"]) if obj.get("tasks_per_core") is not None else None,
            "tasks_per_tres": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["tasks_per_tres"]) if obj.get("tasks_per_tres") is not None else None,
            "tasks_per_node": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["tasks_per_node"]) if obj.get("tasks_per_node") is not None else None,
            "tasks_per_socket": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["tasks_per_socket"]) if obj.get("tasks_per_socket") is not None else None,
            "tasks_per_board": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["tasks_per_board"]) if obj.get("tasks_per_board") is not None else None,
            "cpus": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["cpus"]) if obj.get("cpus") is not None else None,
            "node_count": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["node_count"]) if obj.get("node_count") is not None else None,
            "tasks": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["tasks"]) if obj.get("tasks") is not None else None,
            ...
            "minimum_cpus_per_node": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["minimum_cpus_per_node"]) if obj.get("minimum_cpus_per_node") is not None else None,
            "minimum_tmp_disk_per_node": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["minimum_tmp_disk_per_node"]) if obj.get("minimum_tmp_disk_per_node") is not None else None,
            "power": V0041OpenapiJobInfoRespJobsInnerPower.from_dict(obj["power"]) if obj.get("power") is not None else None,
            "preempt_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["preempt_time"]) if obj.get("preempt_time") is not None else None,
            "preemptable_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["preemptable_time"]) if obj.get("preemptable_time") is not None else None,
            "pre_sus_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["pre_sus_time"]) if obj.get("pre_sus_time") is not None else None,
            "hold": obj.get("hold"),
            ...
            "resize_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["resize_time"]) if obj.get("resize_time") is not None else None,
            ...
            "sockets_per_node": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["sockets_per_node"]) if obj.get("sockets_per_node") is not None else None,
            "start_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["start_time"]) if obj.get("start_time") is not None else None,
            ...
            "submit_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["submit_time"]) if obj.get("submit_time") is not None else None,
            "suspend_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["suspend_time"]) if obj.get("suspend_time") is not None else None,
            "system_comment": obj.get("system_comment"),
            "time_limit": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["time_limit"]) if obj.get("time_limit") is not None else None,
            "time_minimum": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["time_minimum"]) if obj.get("time_minimum") is not None else None,
            "threads_per_core": V0041JobDescMsgDistributionPlaneSize.from_dict(obj["threads_per_core"]) if obj.get("threads_per_core") is not None else None,
