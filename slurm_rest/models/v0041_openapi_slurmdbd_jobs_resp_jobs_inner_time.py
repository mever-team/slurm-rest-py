...
class V0041OpenapiSlurmdbdJobsRespJobsInnerTime(BaseModel):
    ...
    limit: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    total: Optional[V0040JobTimeSystem] = None
    user: Optional[V0040JobTimeSystem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["limit"]) if obj.get("limit") is not None else None,
            "total": V0040JobTimeSystem.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "user": V0040JobTimeSystem.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
