...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerStatisticsEnergy(BaseModel):
    ...
    """ # noqa: E501
    consumed: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumed": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["consumed"]) if obj.get("consumed") is not None else None
        })
        return _obj
