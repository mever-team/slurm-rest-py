...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxJobsPer(BaseModel):
    ...
    """ # noqa: E501
    count: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    accruing: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    submitted: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    wall_clock: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["count"]) if obj.get("count") is not None else None,
            "accruing": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None,
            "submitted": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["submitted"]) if obj.get("submitted") is not None else None,
            "wall_clock": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None
        })
        return _obj
