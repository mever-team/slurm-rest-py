...
class V0041OpenapiJobInfoRespJobsInnerJobResources(BaseModel):
    ...
    """ # noqa: E501
    select_type: List[StrictStr] = Field(description="Scheduling consumption resource selection type")
    nodes: Optional[V0041OpenapiJobInfoRespJobsInnerJobResourcesNodes] = None
    cpus: StrictInt = Field(description="Number of processors in the allocation")
