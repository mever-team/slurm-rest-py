...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPer(BaseModel):
    ...
    """ # noqa: E501
    qos: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    job: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qos": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["qos"]) if obj.get("qos") is not None else None,
            "job": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
