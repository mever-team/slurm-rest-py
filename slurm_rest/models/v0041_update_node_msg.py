...
class V0041UpdateNodeMsg(BaseModel):
    ...
    features: Optional[List[StrictStr]] = Field(default=None, description="new available feature for node")
    features_act: Optional[List[StrictStr]] = Field(default=None, description="new active feature for node")
    gres: Optional[StrictStr] = Field(default=None, description="new generic resources for node")
    address: Optional[List[StrictStr]] = Field(default=None, description="communication name")
    hostname: Optional[List[StrictStr]] = Field(default=None, description="node's hostname")
    name: Optional[List[StrictStr]] = Field(default=None, description="node to update")
