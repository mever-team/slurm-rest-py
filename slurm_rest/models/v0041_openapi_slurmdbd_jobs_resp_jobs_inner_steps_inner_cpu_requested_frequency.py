...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerCPURequestedFrequency(BaseModel):
    ...
    """ # noqa: E501
    min: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    max: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "min": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
