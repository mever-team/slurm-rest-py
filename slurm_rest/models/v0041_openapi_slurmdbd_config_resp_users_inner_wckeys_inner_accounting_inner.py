...
class V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInnerAccountingInner(BaseModel):
    ...
    tres: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner] = Field(default=None, alias="TRES")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "start": obj.get("start"),
            "TRES": V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner.from_dict(obj["TRES"]) if obj.get("TRES") is not None else None
        })
        return _obj
