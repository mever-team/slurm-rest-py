...
class V0041OpenapiUsersAddCondRespAssociationConditionAssociation(BaseModel):
    ...
    grptres: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = None
    grptresmins: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Max number of cpu minutes the underlying group of associations can run for")
    grptresrunmins: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Max number of cpu minutes the underlying group of associations can having running at one time")
    ...
    maxtresminsperjob: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Max number of cpu minutes this association can have per job")
    maxtresrunmins: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Max number of cpu minutes this association can having running at one time")
    maxtresperjob: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Max number of cpus this association can allocate per job")
    maxtrespernode: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = Field(default=None, description="Max number of TRES this association can allocate per node")
    ...
    priority: Optional[V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority] = None
    qoslevel: Optional[List[StrictStr]] = Field(default=None, description="Default QoS' that jobs are able to run at for this association")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priority": V0041OpenapiUsersAddCondRespAssociationConditionAssociationPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
