...
class V0041OpenapiSlurmdbdJobsRespJobsInnerHet(BaseModel):
    ...
    job_offset: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "job_offset": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["job_offset"]) if obj.get("job_offset") is not None else None
        })
        return _obj
