...
class V0041OpenapiSlurmdbdConfigRespAssociationsInnerMaxTresGroup(BaseModel):
    ...
    """ # noqa: E501
    minutes: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = None
    active: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTresRequestedMaxInner]] = None
