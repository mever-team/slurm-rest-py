...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTime(BaseModel):
    ...
    end: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    start: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    suspended: Optional[StrictInt] = None
    system: Optional[V0040StepTimeSystem] = None
    total: Optional[V0040StepTimeSystem] = None
    user: Optional[V0040StepTimeSystem] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "end": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "start": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "suspended": obj.get("suspended"),
            "system": V0040StepTimeSystem.from_dict(obj["system"]) if obj.get("system") is not None else None,
            "total": V0040StepTimeSystem.from_dict(obj["total"]) if obj.get("total") is not None else None,
            "user": V0040StepTimeSystem.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
