...
class V0041OpenapiDiagRespStatistics(BaseModel):
    ...
    req_time: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    req_time_start: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    schedule_cycle_sum: Optional[StrictInt] = None
    ...
    schedule_cycle_depth: Optional[StrictInt] = None
    ...
    job_states_ts: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    ...
    bf_cycle_max: Optional[StrictInt] = None
    ...
    bf_table_size_sum: Optional[StrictInt] = None
    bf_table_size_mean: Optional[StrictInt] = None
    bf_when_last_cycle: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu] = None
    bf_active: Optional[StrictBool] = None
    rpcs_by_message_type: Optional[List[V0041OpenapiDiagRespStatisticsRpcsByMessageTypeInner]] = Field(default=None, description="RPCs by type")
    rpcs_by_user: Optional[List[V0041OpenapiDiagRespStatisticsRpcsByUserInner]] = Field(default=None, description="RPCs by user")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "req_time": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["req_time"]) if obj.get("req_time") is not None else None,
            "req_time_start": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["req_time_start"]) if obj.get("req_time_start") is not None else None,
            ...
            "job_states_ts": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["job_states_ts"]) if obj.get("job_states_ts") is not None else None,
            ...
            "bf_when_last_cycle": V0041OpenapiSlurmdbdJobsRespJobsInnerRequiredMemoryPerCpu.from_dict(obj["bf_when_last_cycle"]) if obj.get("bf_when_last_cycle") is not None else None,
