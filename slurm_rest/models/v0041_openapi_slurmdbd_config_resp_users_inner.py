...
class V0041OpenapiSlurmdbdConfigRespUsersInner(BaseModel):
    ...
    associations: Optional[List[V0041OpenapiSlurmdbdJobsRespJobsInnerAssociation]] = None
    coordinators: Optional[List[V0041OpenapiSlurmdbdConfigRespAccountsInnerCoordinatorsInner]] = None
    default: Optional[V0040UserDefault] = None
    flags: Optional[List[StrictStr]] = None
    name: StrictStr
    old_name: Optional[StrictStr] = None
    wckeys: Optional[List[V0041OpenapiSlurmdbdConfigRespUsersInnerWckeysInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "associations": [V0041OpenapiSlurmdbdJobsRespJobsInnerAssociation.from_dict(_item) for _item in obj["associations"]] if obj.get("associations") is not None else None,
