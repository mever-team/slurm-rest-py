...
class V0041OpenapiSlurmdbdStatsRespStatistics(BaseModel):
    ...
    rpcs: Optional[List[V0041OpenapiSlurmdbdStatsRespStatisticsRPCsInner]] = Field(default=None, alias="RPCs")
    users: Optional[List[V0041OpenapiSlurmdbdStatsRespStatisticsUsersInner]] = None
