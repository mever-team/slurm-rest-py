...
class V0041OpenapiSlurmdbdConfigRespQosInner(BaseModel):
    ...
    priority: Optional[V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId] = None
    usage_factor: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor] = None
    usage_threshold: Optional[V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "priority": V0041OpenapiSlurmdbdJobsRespJobsInnerArrayTaskId.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "usage_factor": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor.from_dict(obj["usage_factor"]) if obj.get("usage_factor") is not None else None,
            "usage_threshold": V0041OpenapiSlurmdbdConfigRespQosInnerLimitsFactor.from_dict(obj["usage_threshold"]) if obj.get("usage_threshold") is not None else None
        })
        return _obj
