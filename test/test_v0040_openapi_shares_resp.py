    ...
    def make_instance(self, include_optional) -> V0040OpenapiSharesResp:
        ...
        if include_optional:
            return V0040OpenapiSharesResp(
                shares = slurm_rest.models.v0/0/40_shares_resp_msg.v0.0.40_shares_resp_msg(
                    shares = [
                        slurm_rest.models.v0/0/40_assoc_shares_obj_wrap.v0.0.40_assoc_shares_obj_wrap(
                            id = 56, 
                            cluster = '', 
                            name = '', 
                            parent = '', 
                            partition = '', 
                            shares_normalized = slurm_rest.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                                set = True, 
                                infinite = True, 
                                number = 1.337, ), 
                            tres = slurm_rest.models.v0_0_40_assoc_shares_obj_wrap_tres.v0_0_40_assoc_shares_obj_wrap_tres(
                                run_seconds = [
                                    slurm_rest.models.v0/0/40_shares_uint64_tres.v0.0.40_shares_uint64_tres(
                                        name = '', 
                                        value = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                                            set = True, 
                                            infinite = True, 
                                            number = 56, ), )
                                    ], 
                                ...
                                usage = [
                                    slurm_rest.models.v0/0/40_shares_float128_tres.v0.0.40_shares_float128_tres(
                                        name = '', )
                                    ], ), 
                            effective_usage = 1.337, 
                            usage_normalized = slurm_rest.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                                set = True, 
                                infinite = True, 
                                number = 1.337, ), 
                            usage = 56, 
