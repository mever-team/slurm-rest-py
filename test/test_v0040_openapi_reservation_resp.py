    ...
    def make_instance(self, include_optional) -> V0040OpenapiReservationResp:
        ...
        if include_optional:
            return V0040OpenapiReservationResp(
                reservations = [
                    slurm_rest.models.v0/0/40_reservation_info.v0.0.40_reservation_info(
                        accounts = '', 
                        burst_buffer = '', 
                        core_count = 56, 
                        core_specializations = [
                            slurm_rest.models.v0/0/40_reservation_core_spec.v0.0.40_reservation_core_spec(
                                node = '', 
                                core = '', )
                            ], 
                        ...
                        node_list = '', 
                        partition = '', 
                        purge_completed = slurm_rest.models.v0_0_40_reservation_info_purge_completed.v0_0_40_reservation_info_purge_completed(
                        ...
                        start_time = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                            ...
                            infinite = True, 
                            number = 56, ), 
                        watts = slurm_rest.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        tres = '', 
