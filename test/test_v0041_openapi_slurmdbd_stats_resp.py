    ...
    def make_instance(self, include_optional) -> V0041OpenapiSlurmdbdStatsResp:
        ...
        if include_optional:
            return V0041OpenapiSlurmdbdStatsResp(
                statistics = slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics.v0_0_41_openapi_slurmdbd_stats_resp_statistics(
                    time_start = 56, 
                    rollups = slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups(
                        hourly = slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_hourly.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_hourly(
                            count = 56, 
                            last_run = 56, 
                            duration = slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_hourly_duration.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_hourly_duration(
                                ...
                                max = 56, 
                                time = 56, ), ), 
                        daily = slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_daily.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_daily(
                            count = 56, 
                            last_run = 56, ), 
                        monthly = slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_monthly.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rollups_monthly(
                            count = 56, 
                            last_run = 56, ), ), 
                    rpcs = [
                        slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_rpcs_inner.v0_0_41_openapi_slurmdbd_stats_resp_statistics_RPCs_inner(
                            rpc = '', 
                            count = 56, 
                    ...
                    users = [
                        slurm_rest.models.v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner.v0_0_41_openapi_slurmdbd_stats_resp_statistics_users_inner(
                            user = '', 
                            count = 56, )
                        ], ),
