    ...
    def make_instance(self, include_optional) -> V0041OpenapiReservationResp:
        ...
        if include_optional:
            return V0041OpenapiReservationResp(
                reservations = [
                    slurm_rest.models.v0_0_41_openapi_reservation_resp_reservations_inner.v0_0_41_openapi_reservation_resp_reservations_inner(
                        accounts = '', 
                        burst_buffer = '', 
                        core_count = 56, 
                        core_specializations = [
                            slurm_rest.models.v0_0_41_openapi_reservation_resp_reservations_inner_core_specializations_inner.v0_0_41_openapi_reservation_resp_reservations_inner_core_specializations_inner(
                                node = '', 
                                core = '', )
                            ], 
                        ...
                        node_list = '', 
                        partition = '', 
                        purge_completed = slurm_rest.models.v0_0_41_openapi_reservation_resp_reservations_inner_purge_completed.v0_0_41_openapi_reservation_resp_reservations_inner_purge_completed(
                        ...
                        start_time = slurm_rest.models.v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required_memory_per_cpu.v0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required_memory_per_cpu(
                            ...
                            infinite = True, 
                            number = 56, ), 
                        watts = slurm_rest.models.v0_0_41_openapi_reservation_resp_reservations_inner_watts.v0_0_41_openapi_reservation_resp_reservations_inner_watts(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        tres = '', 
                ...
                last_update = slurm_rest.models.v0_0_41_openapi_reservation_resp_last_update.v0_0_41_openapi_reservation_resp_last_update(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
