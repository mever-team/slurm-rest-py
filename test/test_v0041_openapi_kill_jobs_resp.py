    ...
    def make_instance(self, include_optional) -> V0041OpenapiKillJobsResp:
        ...
        if include_optional:
            return V0041OpenapiKillJobsResp(
                status = [
                    slurm_rest.models.v0_0_41_openapi_kill_jobs_resp_status_inner.v0_0_41_openapi_kill_jobs_resp_status_inner(
                        error = slurm_rest.models.v0_0_40_kill_jobs_resp_job_error.v0_0_40_kill_jobs_resp_job_error(
                            string = '', 
                            code = 56, 
                            message = '', ), 
                        step_id = '', 
                        job_id = slurm_rest.models.v0_0_41_openapi_kill_jobs_resp_status_inner_job_id.v0_0_41_openapi_kill_jobs_resp_status_inner_job_id(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
