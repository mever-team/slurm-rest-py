    ...
    def make_instance(self, include_optional) -> V0041OpenapiLicensesResp:
        ...
        if include_optional:
            return V0041OpenapiLicensesResp(
                licenses = [
                    slurm_rest.models.v0_0_41_openapi_licenses_resp_licenses_inner.v0_0_41_openapi_licenses_resp_licenses_inner(
                        license_name = '', 
                        total = 56, 
                        used = 56, 
                        free = 56, 
                ...
                last_update = slurm_rest.models.v0_0_41_openapi_licenses_resp_last_update.v0_0_41_openapi_licenses_resp_last_update(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
