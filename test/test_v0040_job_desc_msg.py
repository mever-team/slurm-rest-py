    ...
    def make_instance(self, include_optional) -> V0040JobDescMsg:
        ...
        if include_optional:
            return V0040JobDescMsg(
                ...
                array = '',
                batch_features = '',
                begin_time = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                flags = [
                ...
                cpu_frequency = '',
                cpus_per_tres = '',
                crontab = slurm_rest.models.v0/0/40_cron_entry.v0.0.40_cron_entry(
                    flags = [
                        'WILD_MINUTE'
                        ], 
                    minute = '', 
                ...
                rlimits = slurm_rest.models.v0_0_40_job_desc_msg_rlimits.v0_0_40_job_desc_msg_rlimits(
                    cpu = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    fsize = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    data = , 
                ...
                kill_warning_signal = '',
                kill_warning_delay = slurm_rest.models.v0/0/40_uint16_no_val.v0.0.40_uint16_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                ...
                selinux_context = '',
                required_switches = slurm_rest.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                standard_error = '',
