    ...
    def make_instance(self, include_optional) -> V0040StatsMsg:
        ...
        if include_optional:
            return V0040StatsMsg(
                parts_packed = 56,
                req_time = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                req_time_start = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                ...
                schedule_exit = slurm_rest.models.v0/0/40_schedule_exit_fields.v0.0.40_schedule_exit_fields(
                    end_job_queue = 56, 
                ...
                jobs_pending = 56,
                jobs_running = 56,
                job_states_ts = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                ...
                bf_when_last_cycle = slurm_rest.models.v0/0/40_uint64_no_val.v0.0.40_uint64_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                bf_active = True,
                bf_exit = slurm_rest.models.v0/0/40_bf_exit_fields.v0.0.40_bf_exit_fields(
                    end_job_queue = 56, 
                    bf_max_job_start = 56, 
                    bf_max_job_test = 56, 
                    bf_max_time = 56, 
                ...
                rpcs_by_message_type = [
                    slurm_rest.models.v0_0_40_stats_msg_rpcs_by_type_inner.v0_0_40_stats_msg_rpcs_by_type_inner(
                        message_type = '', 
                        type_id = 56, 
                        count = 56, 
                        average_time = 56, 
                ...
                rpcs_by_user = [
                    slurm_rest.models.v0_0_40_stats_msg_rpcs_by_user_inner.v0_0_40_stats_msg_rpcs_by_user_inner(
                        user = '', 
                        user_id = 56, 
                        count = 56, 
                        average_time = 56, 
